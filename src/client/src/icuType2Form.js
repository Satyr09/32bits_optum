...
function IcuType2Form({ id, classes, name, db, setFresh, setLoading }) {
  ...
  const writeToDB = (name, res) => {
    console.log("Commencing database write with : ", res);
...
export default withStyles(style)(IcuType2Form);
