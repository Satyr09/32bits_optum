# -*- coding: utf-8 -*-
"""
Created on Wed Oct 30 23:04:27 2019
...
data = pd.read_csv("F:\optum\\data\\f_data_cut_icutype_3.csv")
...
clf2 = RandomForestClassifier(n_jobs=-1,max_features= 'sqrt' ,n_estimators=225, oob_score = True)
